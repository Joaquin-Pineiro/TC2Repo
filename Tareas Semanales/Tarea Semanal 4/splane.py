...
def analyze_sys( all_sys,xlim,ylim, sys_name = None, img_ext = 'none', same_figs=True ):
    ...
    for ii in range(cant_sys):
        fig_id, axes_hdl = bodePlot(all_sys[ii],xlim, ylim, fig_id, axes_hdl, label = sys_name[ii])
